...
-  [`babashka.fs`](#babashka.fs) 
    ...
    -  [`copy`](#babashka.fs/copy) - Copies <code>source</code> file or input-stream to <code>target-path</code> dir or file via [Files/copy](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/Files.html#copy(java.nio.file.Path,java.nio.file.Path,java.nio.file.CopyOption...)).
    ...
    -  [`creation-time`](#babashka.fs/creation-time) - Returns creation time of <code>path</code> as [FileTime](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/FileTime.html) (JVM) or BigInt nanoseconds (Node.js).
    ...
    -  [`file-time->instant`](#babashka.fs/file-time->instant) - Converts file time <code>ft</code> (<code>FileTime</code> on the JVM, BigInt nanoseconds on Node.js) to an [Instant](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/Instant.html).
    -  [`file-time->millis`](#babashka.fs/file-time->millis) - Converts file time <code>ft</code> (<code>FileTime</code> on the JVM, BigInt nanoseconds on Node.js) to epoch milliseconds.
    ...
    -  [`instant->file-time`](#babashka.fs/instant->file-time) - Converts <code>instant</code> to a file time (<code>FileTime</code> on the JVM, BigInt nanoseconds on Node.js).
    -  [`last-modified-time`](#babashka.fs/last-modified-time) - Returns last modified time of <code>path</code> as [FileTime](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/FileTime.html) (JVM) or BigInt nanoseconds (Node.js).
    ...
    -  [`millis->file-time`](#babashka.fs/millis->file-time) - Converts epoch milliseconds to a file time (<code>FileTime</code> on the JVM, BigInt nanoseconds on Node.js).
    ...
    -  [`owner`](#babashka.fs/owner) - Returns the owner of <code>path</code> via [Files/getOwner](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/Files.html#getOwner(java.nio.file.Path,java.nio.file.LinkOption...)): a <code>UserPrincipal</code> on the JVM (call <code>str</code> on it to get the owner name), the numeric <code>uid</code> on Node.js, which cannot resolve it to a name.
    ...
    -  [`posix-file-permissions`](#babashka.fs/posix-file-permissions) - Returns POSIX permissions for <code>path</code>: a set of <code>PosixFilePermission</code> on the JVM, the permission bits as an integer (e.g.
    ...
    -  [`slurp`](#babashka.fs/slurp) - Reads file as text.
    -  [`spit`](#babashka.fs/spit) - Writes <code>content</code> to <code>file</code> as text.
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L246-L250">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L302-L311">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L329-L346">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L293-L300">Source</a></sub></p>

## <a name="babashka.fs/copy">`copy`</a>
``` clojure
(copy source target-path)
(copy source target-path opts)
```
Function.
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L771-L803">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L985-L1074">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L861-L879">Source</a></sub></p>
...
* `:posix-file-permissions` - string format for unix-like system permissions for `dir`, as described in [`str->posix`](#babashka.fs/str->posix).
Affected by [umask](/README.md#umask).
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L894-L912">Source</a></sub></p>
...
Affected by [umask](/README.md#umask).
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1278-L1295">Source</a></sub></p>
...
Returns `link`.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1192-L1200">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1176-L1190">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1082-L1119">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1121-L1174">Source</a></sub></p>

## <a name="babashka.fs/creation-time">`creation-time`</a>
``` clojure
(creation-time path)
(creation-time path opts)
```
Function.
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1570-L1579">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1209-L1218">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1220-L1232">Source</a></sub></p>
...
Returns `path`.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1351-L1366">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1242-L1276">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L225-L235">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L968-L983">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1689-L1696">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L252-L256">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L274-L285">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1679-L1682">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L111-L118">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L365-L370">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L595-L598">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1507-L1513">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1522-L1527">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1424-L1434">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L704-L739">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L237-L244">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1515-L1520">Source</a></sub></p>

## <a name="babashka.fs/last-modified-time">`last-modified-time`</a>
``` clojure
(last-modified-time path)
(last-modified-time path opts)
```
Function.
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1546-L1553">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L546-L562">Source</a></sub></p>
...
- `glob-or-accept` - a [`glob`](#babashka.fs/glob) string such as `"*.edn"` or a `(fn accept [^java.nio.file.Path p]) -> truthy`
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1639-L1643">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L621-L702">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1529-L1534">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1804-L1816">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1297-L1331">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L323-L327">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L199-L209">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1333-L1341">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L88-L107">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L600-L603">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L807-L814">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L927-L939">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1378-L1382">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1389-L1410">Source</a></sub></p>
...
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1473-L1484">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1442-L1471">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1202-L1207">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L258-L262">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L185-L197">Source</a></sub></p>
...
Options:
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L213-L223">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L313-L321">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L348-L363">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1368-L1376">Source</a></sub></p>
...
Returns `path`.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1486-L1505">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1581-L1601">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1555-L1568">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L914-L925">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1343-L1347">Source</a></sub></p>

## <a name="babashka.fs/slurp">`slurp`</a>
``` clojure
(slurp file)
(slurp file {:keys [charset], :or {charset "utf-8"}})
```
Function.
...
``` clojure
(spit file content)
(spit file content {:keys [charset append], :or {charset "utf-8"}})
```
Function.
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1645-L1670">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1684-L1687">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L952-L966">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L816-L830">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1672-L1677">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1234-L1240">Source</a></sub></p>
...
* [`:nofollow-links`](/README.md#nofollow-links)
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1603-L1637">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1820-L1864">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L376-L474">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1706-L1755">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1757-L1761">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L264-L268">Source</a></sub></p>

## <a name="babashka.fs/write-bytes">`write-bytes`</a>
``` clojure
(write-bytes file bytes)
(write-bytes file bytes {:keys [append], :as opts})
```
Function.
...
(write-lines file lines {:keys [charset append], :or {charset "utf-8"}, :as opts})
```
Function.
