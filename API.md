...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L103-L105)
### `absolutize`
<code>[f]</code><br>

Converts f into an absolute path via Path#toAbsolutePath.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L138-L140)
### `canonicalize`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L152-L161)
### `components`
<code>[f]</code><br>

Returns a seq of all components of f.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L133-L136)
### `copy`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L342-L358)
### `copy-tree`
<code>[src dest]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L405-L443)
### `create-dir`
<code>[path]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L391-L397)
### `create-dirs`
<code>[path]</code><br>
<code>[path {:keys [:posix-file-permissions]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L399-L403)
### `create-file`
<code>[path]</code><br>
<code>[path {:keys [:posix-file-permissions]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L546-L552)
### `create-link`
<code>[path target]</code><br>

Create a hard link from path to target.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L510-L515)
### `create-sym-link`
<code>[path target]</code><br>

Create a soft link from path to target.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L502-L508)
### `create-temp-dir`
<code>[]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L450-L472)
### `create-temp-file`
<code>[]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L474-L500)
### `creation-time`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L700-L705)
### `cwd`
<code>[]</code><br>

Returns current working directory as path

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L1009-L1012)
### `delete`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L517-L523)
### `delete-if-exists`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L525-L529)
### `delete-on-exit`
<code>[f]</code><br>

Requests delete on exit via File#deleteOnExit. Returns f.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L578-L582)
### `delete-tree`
<code>[root]</code><br>

Deletes a file tree using walk-file-tree. Similar to rm -rf. Does not follow symlinks.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L534-L544)
### `directory?`
<code>[f]</code><br>
<code>[f {:keys [:nofollow-links]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L86-L91)
### `ends-with?`
<code>[this other]</code><br>

Returns true if path this ends with path other.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L833-L836)
### `exec-paths`
<code>[]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L759-L763)
### `executable?`
<code>[f]</code><br>

Returns true if f is executable.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L107-L109)
### `exists?`
<code>[f]</code><br>
<code>[f {:keys [:nofollow-links]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L123-L129)
### `expand-home`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L987-L1002)
### `extension`
<code>[path]</code><br>

Returns the extension of a file

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L749-L752)
### `file`
<code>[f]</code><br>
<code>[f & fs]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L57-L62)
### `file-name`
<code>[x]</code><br>

Returns the name of the file or directory. E.g. (file-name "foo/bar/baz") returns "baz".

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L163-L166)
### `file-separator`

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L234-L234)
### `file-time->instant`
<code>[ft]</code><br>

Converts a java.nio.file.attribute.FileTime to a java.time.Instant.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L661-L664)
### `file-time->millis`
<code>[ft]</code><br>

Converts a java.nio.file.attribute.FileTime to epoch millis (long).

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L671-L674)
### `get-attribute`
<code>[path attribute]</code><br>
<code>[path attribute {:keys [:nofollow-links]}]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L611-L617)
### `glob`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L308-L331)
### `hidden?`
<code>[f]</code><br>

Returns true if f is hidden.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L99-L101)
### `home`
<code>[]</code><br>
<code>[user]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L979-L985)
### `instant->file-time`
<code>[instant]</code><br>

Converts a java.time.Instant to a java.nio.file.attribute.FileTime.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L666-L669)
### `last-modified-time`
<code>[f]</code><br>
<code>[f {:keys [nofollow-links] :as opts}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L686-L691)
### `list-dir`
<code>[dir]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L224-L232)
### `list-dirs`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L714-L718)
### `match`
<code>[root pattern]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L242-L306)
### `millis->file-time`
<code>[millis]</code><br>

Converts epoch millis (long) to a java.nio.file.attribute.FileTime.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L676-L679)
### `modified-since`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L865-L874)
### `move`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L554-L567)
### `normalize`
<code>[f]</code><br>

Normalizes f via Path#normalize.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L147-L150)
### `parent`
<code>[f]</code><br>

Returns parent of f, is it exists.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L569-L572)
### `path`
<code>[f]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L47-L55)
### `path-separator`

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L235-L235)
### `posix->str`
<code>[p]</code><br>

Converts a set of PosixFilePermission to a string.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L360-L363)
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L589-L593)
### `read-all-bytes`
<code>[f]</code><br>

Returns contents of file as byte array.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L600-L603)
### `read-all-lines`
<code>[f]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L605-L607)
### `read-attributes`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L642-L650)
### `read-attributes*`
<code>[path attributes]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L624-L640)
### `readable?`
<code>[f]</code><br>

Returns true if f is readable

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L111-L113)
### `real-path`
<code>[f]</code><br>
<code>[f {:keys [:nofollow-links]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L71-L75)
### `regular-file?`
<code>[f]</code><br>
<code>[f {:keys [:nofollow-links]}]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L79-L84)
### `relative?`
<code>[f]</code><br>

Returns true if f represents a relative path.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L119-L121)
### `relativize`
<code>[this other]</code><br>

Returns relative path by comparing this with other.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L142-L145)
### `same-file?`
<code>[this other]</code><br>

Returns true if this is the same file as other.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L595-L598)
### `set-attribute`
<code>[path attribute value]</code><br>
<code>[path attribute value {:keys [:nofollow-links]}]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L652-L659)
### `set-creation-time`
<code>[f time]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L707-L712)
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L693-L698)
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L584-L587)
### `size`
<code>[f]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L574-L576)
### `split-ext`
<code>[path]</code><br>

Splits a path into a vec of [path-without-ext ext]. Works with strings, files, or paths.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L720-L730)
### `split-paths`
<code>[joined-paths]</code><br>

Splits a string joined by the OS-specific path-seperator into a vec of paths.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L754-L757)
### `starts-with?`
<code>[this other]</code><br>

Returns true if path this starts with path other.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L828-L831)
### `str->posix`
<code>[s]</code><br>

Converts a string to a set of PosixFilePermission.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L365-L368)
### `strip-ext`
<code>[path]</code><br>
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L732-L747)
### `sym-link?`
<code>[f]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L531-L532)
### `temp-dir`
<code>[]</code><br>

Returns java.io.tmpdir property as path.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L445-L448)
### `unzip`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L880-L907)
### `walk-file-tree`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L170-L204)
### `which`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L772-L815)
### `which-all`
<code>[program]</code><br>
<code>[program opts]</code><br>

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L817-L820)
### `windows?`
<code>[]</code><br>

Returns true if OS is Windows.

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L1004-L1007)
### `with-temp-dir`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L957-L971)
### `writable?`
<code>[f]</code><br>

Returns true if f is writable

[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L115-L117)
### `zip`
...
[Source](https://github.com/babashka/process/blob/master/src/babashka/fs.cljc#L938-L953)
