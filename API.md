...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L382-L400">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L471-L518">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L443-L448">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L648-L657">Source</a></sub></p>
...
Creates a temporary directory using Files#createDirectories.
  ...
  File permissions can be specified with an `:posix-file-permissions` option.
  String format for posix file permissions is described in the [`str->posix`](#babashka.fs/str->posix) docstring.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L527-L552">Source</a></sub></p>
...
Creates an empty temporary file using Files#createTempFile.
  ...
  File permissions can be specified with an `:posix-file-permissions` option.
  String format for posix file permissions is described in the [`str->posix`](#babashka.fs/str->posix) docstring.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L554-L585">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1192-L1195">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L607-L613">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L626-L646">Source</a></sub></p>
...
If [`path`](#babashka.fs/path) begins with a tilde (`~`), expand the tilde to the value
  ...
  `user.home`.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1169-L1185">Source</a></sub></p>
...
Given a file and glob pattern, returns matches as vector of
  ...
  * `:max-depth` - max depth to descend into directory structure.
  ...
  Examples:
  `(fs/glob "." "**.clj")`
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L346-L371">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1092-L1112">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1114-L1135">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1161-L1167">Source</a></sub></p>
...
Similar to list-dir but accepts multiple roots and returns the concatenated results.
  - `glob-or-accept` - a glob string such as "*.edn" or a (fn accept [^java.nio.file.Path p]) -> truthy
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L820-L824">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L277-L344">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L984-L993">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L519-L519">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L748-L756">Source</a></sub></p>
...
Splits path on extension If provided, a specific extension `ext`, the
  ...
  are not processed.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L826-L844">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1284-L1289">Source</a></sub></p>
...
Unzips `zip-file` to `dest` directory (default `"."`).
   ...
   Options:
   * `:replace-existing` - `true` / `false`: overwrite existing files
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L999-L1027">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1264-L1282">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L877-L929">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1187-L1190">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1139-L1153">Source</a></sub></p>
...
Writes `bytes` to [`path`](#babashka.fs/path) via `java.nio.file.Files/write`.
  ...
  * or any `java.nio.file.StandardOption`.
  ...
  ```
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1218-L1241">Source</a></sub></p>
...
Writes `lines`, a seqable of strings to [`path`](#babashka.fs/path) via `java.nio.file.Files/write`.
  ...
  * `:append` (default `false`)
  * or any `java.nio.file.StandardOption`.
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1243-L1262">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/fs/blob/master/src/babashka/fs.cljc#L1060-L1086">Source</a></sub></p>
