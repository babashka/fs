...
- [#152](https://github.com/babashka/fs/issues/152): an empty-string path `""` is now (typically) understood to be the current working directory (as per underlying JDK file APIs) 
